        ...
        <div className="mx-56 grid grid-cols-2 gap-4 text-heading font-bold mt-10">
            {
                ...
                <button className={`flex flex-col px-20 py-10 items-center border-2 ${selectedButton == 'files' ? 'border-primary bg-[#181B1F]' : 'border-[#50575F]'} rounded-2xl`} 
                    onClick={() => {
                ...
                <button className={`flex flex-col px-20 py-10 items-center border-2 ${selectedButton == 'notion' ? 'border-primary bg-[#181B1F]' : 'border-[#50575F]'} rounded-2xl`} 
                    onClick={() => {
