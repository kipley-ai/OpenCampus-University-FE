...
const ManageDataSources = () => {
	...
	const totalPages = Math.ceil(Number(data.length) / Number(perPage));
		...
		<div className="flex flex-col sm:px-6 lg:px-0 py-8 bg-[#292D32] text-heading">
			<div className="mx-64">
				<div className="flex justify-between items-center mb-4">
					...
					{/* Add New Button */}
					<button
						className="flex items-center justify-center bg-primary rounded-3xl py-2 px-5"
						type="submit"
					>
				...
				{/* Pagination */}
                <div className="pt-2">
                    <PaginationController totalPages={totalPages} pageQuery="page" />
                </div>
			</div>
		</div>
	);
