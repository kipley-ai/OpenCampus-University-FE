                ...
                <div className="rounded border border-slate-200 bg-white p-5 shadow-md dark:border-slate-700 dark:bg-slate-800">
                  <div className="mb-5 flex items-center space-x-3">
                    ...
                    <div className="grow">
                      ...
                      <input
                        id="status-input"
                        className="form-input w-full border-transparent bg-slate-100 placeholder-slate-500 focus:bg-white dark:border-transparent dark:bg-slate-900 dark:focus:bg-slate-800"
                        type="text"
