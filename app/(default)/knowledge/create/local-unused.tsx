...
// 			// Check if there's actually a new file
// 			if (
// 				newFileObjects &&
// 				newFileObject &&
// 				(files.length === 0 ||
...
// 				// TODO: Use abortController when file size is big
...
// 			// TODO: Use AbortController to also cancel the big PUT request to S3
...
// 		<div className="mx-64">
// 			<div
// 				className="flex flex-col mt-5 mb-8 border border-dashed border-[#aaa] rounded-xl py-20 px-32 text-center items-center cursor-pointer color-[#aaa] font-inter text-heading "
...
// 									<p className="text-xs">{formatBytes(file.fileObject.size)}</p>
// 								</div>
// 							</div>
// 							{file.status}
// 							<Image
