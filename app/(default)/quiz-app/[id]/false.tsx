...
export default function QuizFalse() {
  ...
  return (
    <div className="flex w-full items-center justify-between rounded-b-xl bg-[#FDE2E1] px-10 py-8 text-white">
      ...
      <button
        className="flex items-center gap-2 rounded-lg bg-[#EF4444] px-6 py-2 hover:bg-[#c23636]"
        onClick={nextPart}
      >
        NEXT
        <svg
