...
export default function QuizQuestion() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="my-10 mt-2 w-full rounded-xl bg-white p-8 shadow-lg">
        <div className="mb-4 flex flex-row">
          <div className="mr-8 mt-4 h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
            <div
              className="h-2.5 rounded-full bg-[#141BEB]"
              style={{ width: `${progress}%` }}
            ></div>
          </div>
          <div className="flex items-center justify-center rounded-lg bg-[#141BEB] px-4 py-2 font-bold text-white shadow-lg">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            <span className="ml-2 text-lg tracking-widest">
