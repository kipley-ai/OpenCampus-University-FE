...
export default function QuizQuestion() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="my-10 mt-2 w-full rounded-xl border border-border bg-white px-10 py-8">
          ...
          {questions.data?.questions?.questions &&
            ["a", "b", "c", "d"].map((choices: any, index: any) => {
              ...
              return (
                <label
                  key={index}
                  className={`flex w-full cursor-pointer flex-row rounded-lg border border-gray-300 px-4 py-3 text-left hover:bg-secondary ${selected_answer === choice ? "bg-blue-100 font-medium" : ""}`}
                >
                  <input
                    type="radio"
                    name="quiz"
