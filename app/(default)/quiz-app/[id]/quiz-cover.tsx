...
export default function QuizCover() {
    const { step, setStep, topic, setTopic, chatbot_id, setChatbotId, questions, setQuestions, session_id, setSessionId } = useQuiz();
    const { id } = useParams();
    ...
    const { data: quizData, refetch: quizRefetch } = useGetQuiz({
            ...
            <div className="w-full">
                ...
                <div className="mt-2 flex flex-row justify-between items-start space-y-0 space-x-6 p-6 rounded-lg shadow-md">
                    <div className="flex flex-col w-2/3 space-y-4">
                        ...
                        />
                        <button
                            className="mt-4 bg-[#141BEB] text-white py-3 px-4 rounded-xl self-end disabled:border-0 disabled:bg-[#B8BABE] disabled:text-[#909295]"
