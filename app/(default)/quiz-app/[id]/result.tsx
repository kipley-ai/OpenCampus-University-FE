            ...
            <div className="bg-white p-8 rounded-xl shadow-lg w-full mx-auto my-10">
                ...
                <div className="flex justify-center mt-2">
                    <div className="flex flex-col items-center bg-[#F9F9FF] p-6 w-full rounded-lg shadow">
                        ...
                        <p className="text-lg font-bold text-center mt-4">Your final score is {total_right} / {totalQuestions} ({percentage}%)</p>
                        <button className="border border-[#141BEB] text-[#141BEB] px-4 py-2 rounded mt-4" onClick={restartQuiz}>
                            Restart the Quiz
                        </button>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col w-1/4 self-center">
                        <div className="flex justify-center items-center mt-8 text-lg">
                            ...
                            <div className="flex flex-col ml-2">
                                ...
                                <p>{totalQuestions - total_right}</p>
                            </div>
                        </div>
                ...
                <div className="flex justify-center mt-8">
                    ...
                    <button className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 ml-4" onClick={returnToDashboard}>
                        Done
                    </button>
                </div>
            </div>
