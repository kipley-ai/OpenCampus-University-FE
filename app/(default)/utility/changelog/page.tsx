          ...
          <div className="max-w-3xl m-auto mt-8">
            ...
            <div className="xl:pl-32 xl:-translate-x-16 mb-2">
              <ul className="flex flex-wrap -m-1">
                <li className="m-1">
                  <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-indigo-500 text-heading duration-150 ease-in-out">View All</button>
                </li>
                <li className="m-1">
