...
export default function CourseDraft() {
  ...
  return (
    <>
      ...
      <div className="flex max-w-[1300px] gap-16 bg-container px-8 py-8">
        ...
        <main className="w-3/4 rounded-2xl border-2 border-border bg-sidebar p-3 md:p-10 xl:mt-4"></main>
      </div>
    </>
  );
}
