...
export const TwitterScrapingStatus = ({
  ...
  if (scrapeStatus?.status === "success") {
    return (
      <div className="flex items-center">
        <svg className="mr-3 size-[40px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="var(--color-primary)" viewBox="0 0 20 20">
  ...
  return (
    <div className="flex items-center">
      <svg aria-hidden="true" role="status" className="mr-3  size-[40px] animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
