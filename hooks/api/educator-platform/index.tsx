...
export const useCreateCourse = () => {
  ...
  return useMutation({
    mutationFn: (data: Omit<IUpdateCourseParams, "uuid">) => {
      const uuid = uuidv4();
      return axios.post(
        "/api/educator-platform/course_create",
        { ...data, uuid },
        {
          headers: {
...
export const useUpdateCourse = () => {
  ...
  return useMutation({
    mutationFn: (params: IUpdateCourseParams) =>
      axios.post(
        `/api/educator-platform/course_update/${params.uuid}`,
        params,
        {
          headers: {
            "x-kf-user-id": address,
...
export const useCourseIndex = (params: ICourseIndexParams) => {
  ...
  return useQuery({
    ...
    queryFn: () =>
      axios.post("/api/educator-platform/course_index", params, {
        headers: {
          "x-kf-user-id": address,
        },
      }),
...
export const useUpdateSection = () => {
  ...
  return useMutation({
    mutationFn: (params: IUpdateSectionParams) =>
      axios.post(
        `/api/educator-platform/section_update/${params.uuid}`,
        params,
        {
          headers: {
            "x-kf-user-id": address,
...
export const useFetchSection = (uuid: string) => {
  ...
  return useQuery({
    ...
    queryFn: () =>
      axios.post(`/api/educator-platform/section_fetch/${uuid}`, null, {
        headers: {
          "x-kf-user-id": address,
        },
      }),
...
export const useSectionIndex = (params: ISectionIndexParams) => {
  ...
  return useQuery({
    ...
    queryFn: () =>
      axios.post("/api/educator-platform/section_index", params, {
        headers: {
          "x-kf-user-id": address,
        },
      }),
...
export const useUpdateLesson = () => {
  ...
  return useMutation({
    mutationFn: (params: IUpdateLessonsParams) =>
      axios.post(
        `/api/educator-platform/lesson_update/${params.uuid}`,
        params,
        {
          headers: {
            "x-kf-user-id": address,
...
export const useLessonIndex = (params: ILessonsIndexParams) => {
  ...
  return useQuery({
    ...
    queryFn: () =>
      axios.post("/api/educator-platform/lesson_index", params, {
        headers: {
          "x-kf-user-id": address,
        },
      }),
...
export const useCreateFile = () => {
  ...
  return useMutation({
    mutationFn: (data: Omit<IUpdateFilesParams, "uuid">) => {
      const uuid = uuidv4();
      return axios.post(
        "/api/educator-platform/file_create",
        { ...data, uuid },
        {
          headers: {
            "x-kf-user-id": address,
...
export const useFileIndex = (params: IFilesIndexParams) => {
  ...
  return useQuery({
    ...
    queryFn: () =>
      axios.post("/api/educator-platform/file_index", params, {
        headers: {
          "x-kf-user-id": address,
        },
      }),
...
export const useUpdateProfile = () => {
  ...
  return useMutation({
    mutationFn: (params: IUpdateLessonsParams) =>
      axios.post(
        `/api/educator-platform/profile_update/${params.uuid}`,
        params,
        {
          headers: {
            "x-kf-user-id": address,
